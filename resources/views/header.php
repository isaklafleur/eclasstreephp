...
<div id="main">
	...
	<a href="#" class="btn btn-primary" id="save" onclick="save()">Save Template</a>
	<a href="template" class="btn btn-info">Back</a>
	<label id="savedata" class="label label-success"></label>
	<hr>
<form method="post" >
	<input type="hidden" name="_token" value="<?php echo csrf_token(); ?>">
	<input type="text" id="saveas" name="saveas" placeholder="Enter Template Name" class="form-control"/>
	<br>
	<input type="submit" class="btn btn-primary" id="savea" value="Create Clone" />
</form>
	</div>
	<div id="data"></div>
	</div>
	...
	<input type="hidden" id="urlid" value="<?php if(isset($_GET["id"])){echo $_GET["id"];} ?>">
	
	<script type="text/javascript">
	function save(){
		document.getElementById("savedata").innerHTML="Template Saved";
	}
...
param1='1';
			...
			//	var selval=selRootKeys.join(",");
				...
				var str="?values="+selval+"&urlid="+param+"&urlid1="+param1;
